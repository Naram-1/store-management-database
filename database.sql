...
-- Trigger: automatically reduce stock and log change after a sale
...
BEGIN
    ...
    INSERT INTO StockLogs (product_id, change_amount, change_reason, change_date)
    VALUES (NEW.product_id, -NEW.quantity, 'Sale', CURDATE());
END //

DELIMITER ;

-- Function: calculate total value of an order
